function [result]= impact_down_temp(angle, X, Y, global_time, c)
...
% Dummy Value
velocity=5; %As the velocity calculated from the curved part is abnormally large. I will use this dummy value for the time being.
